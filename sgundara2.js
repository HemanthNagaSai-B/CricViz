...
function drawPlot(data){
    ...
    //     const selectedName = this.value;
    //     const selectedData = data.find(d => d[0] === selectedName);
    //     if (selectedData) {
    //         highlightBubble(selectedData);
    //     } else {
    //         clearHighlight();
    //     }
    // });

    // function highlightBubble(playerData) {
    //     // Clear highlights
    //     bubbles.style("stroke", "none");

    //     // Highlight the selected bubble
    //     bubbles.filter(d => d[0] === playerData[0])
    //         .style("stroke", "black")
    //         .style("stroke-width", 3)
    //         .style("stroke-dasharray", "4,2"); // Dashed border
    // }

    // function clearHighlight() {
    //     // Remove borders from all bubbles
    //     bubbles.style("stroke", "none");
    // }
